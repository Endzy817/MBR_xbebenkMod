...
Func SaveConfig_600_6()
	...
	_Ini_Add("MagicItems", "ChkSaleBOS", $g_bChkSaleBOS ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleBOH", $g_bChkSaleBOH ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleBOE", $g_bChkSaleBOE ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleShovel", $g_bChkSaleShovel ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleWallRing", $g_bChkSaleWallRing ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSalePowerPot", $g_bChkSalePowerPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleResourcePot", $g_bChkSaleResourcePot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleTrainingPot", $g_bChkSaleTrainingPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleBuilderPot", $g_bChkSaleBuilderPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleCTPot", $g_bChkSaleCTPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleHeroPot", $g_bChkSaleHeroPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleResearchPot", $g_bChkSaleResearchPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleSuperPot", $g_bChkSaleSuperPot ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleROG", $g_bChkSaleROG ? 1 : 0)
	_Ini_Add("MagicItems", "ChkSaleROE", $g_bChkSaleROE ? 1 : 0)
	...
	_Ini_Add("other", "SkipSnowDetection", $g_bSkipSnowDetection)
...
Func SaveConfig_600_35_2()
	...
	If $iCmbSwitchAcc Then
		...
		IniWrite($sSwitchAccFile, "SwitchAccount", "FastSwitch", $g_bChkFastSwitchAcc ? 1 : 0)
