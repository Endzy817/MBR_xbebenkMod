...
Func ReadConfig_600_6()
	...
	IniReadS($g_bChkSellHeroPot, $g_sProfileConfigPath, "other", "ChkSellHeroPot", False, "Bool")
	...
	IniReadS($g_bSkipSnowDetection, $g_sProfileConfigPath, "other", "SkipSnowDetection", True, "Bool")
